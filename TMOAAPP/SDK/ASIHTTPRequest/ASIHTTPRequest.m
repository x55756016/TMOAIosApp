...
//            [sslProperties setObject:(NSString *)kCFBooleanFalse forKey:(NSString *)kCFStreamSSLValidatesCertificateChain];
            [sslProperties setObject:[NSString stringWithFormat:@"%@",kCFBooleanFalse] forKey:(NSString *)kCFStreamSSLValidatesCertificateChain];
        }
...
//        return [NSDate dateWithTimeIntervalSinceReferenceDate:maxAge];
